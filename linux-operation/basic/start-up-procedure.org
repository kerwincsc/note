...
* 第一步、加载BIOS
  ...
  BIOS的功能由两部分组成，分别是 *POST* 码和 *Runtime* 服务。POST阶段完成后它将从存储器中被清除，而Runtime服务会被一直保留，用于目标操作系统的启动。BIOS两个阶段所做的详细工作如下：
...
参见 http://www.centoscn.com/CentOS/2016/0103/6608.html
